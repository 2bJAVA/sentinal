...
//				INS_freq = 1.0f / ((1000 * HAL_GetTick() + TIM14->CNT - INS_last_time) / 1000000.0f);
...
//        INS_last_time = 1000 * HAL_GetTick() + TIM14->CNT;
    }
}
...
fp32 *get_INS_time_point(void)
{
    return &bmi088_real_data.time;
}
